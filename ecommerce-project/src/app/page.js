...
export default function Example() {
  ...
  return (
    <div className="bg-white">
      {/* Headers */}
      <header className="absolute inset-x-0 top-0 z-50 w-[75%] mx-auto">
        ...
        >
          ...
          <div className=" lg:flex lg:flex-1 lg:justify-end flex">
        ...
        <div className="relative isolate pt-14">
          ...
          <div className="mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
            <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
              <h1 className="mt-10 max-w-lg text-4xl font-bold tracking-tight text-[#11142D] sm:text-6xl">
                Sort out Your Spring Look
              </h1>
              <p className="mt-6 text-lg leading-8 text-[#9A9AB0] w-[65%] ">
              ...
              <div className="mt-10 flex items-center gap-x-6 ">
                <a
                  href="#"
                  className="rounded-[8px] w-[120px] flex justify-around items-center bg-[#F86338] px-3.5 py-2.5 text-md font-sm text-white shadow-sm hover:bg-[#F86338] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#F86338]"
                >
                  Shop
                  <span>
                    {" "}
            ...
            <div className="mt-16 sm:mt-24 lg:mt-0 lg:flex-shrink-0 lg:flex-grow flex">
              <div className="bg-[#E2E2EA] mx-auto w-[504px] max-w-full  h-[619px]"></div>
              {/* <div className="bg-[#E2E2EA] mx-auto w-[504px] max-w-full  h-[619px]"></div> */}
              {/* <svg
                viewBox="0 0 366 729"
                role="img"
